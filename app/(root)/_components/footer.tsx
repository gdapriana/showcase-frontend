    ...
    <div className="flex justify-start items-center gap-2">
      <m.div
        ...
        <m.div
          ...
          className="h-full border-r border-primary bg-white border-r-4 bg-primary-foreground absolute left-0 top-0"></m.div>
        <m.div
          className="flex ml-3 flex-col justify-center items-start">
