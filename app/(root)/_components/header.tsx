  ...
  return (
    <header className="flex gap-2 flex-col justify-center items-start">
      ...
      <m.div
        ...
        <Button size="lg" className="rounded-full py-8 text-base">Got a Project?</Button>
        <Button variant="outline" size="lg" className="rounded-full py-8 text-base">Hire Me!</Button>
      </m.div>
    </header>
  )
}
